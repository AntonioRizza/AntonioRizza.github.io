<body style="background: #111 url('background.jpg') no-repeat center center fixed; background-size: cover; color: #fff;">

<div style="background: rgba(0,0,0,0.7); color: inherit; padding: 32px; border-radius: 12px; display: flex; align-items: flex-start; justify-content: space-between;">
